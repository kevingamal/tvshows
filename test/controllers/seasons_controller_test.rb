...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { begins_at: @season.begins_at, number: @season.number, show_id: @season.show_id } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { begins_at: @season.begins_at, number: @season.number, show_id: @season.show_id } }
